    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="px-0 md:px-16 lg:px-24 py-2 md:py-6">
        ...
        <div className="text-sm text-gray-500 mb-4 md:mb-6 px-4 md:px-0">
          ...
          <span className="text-gray-900">Menu item</span>
        </div>
              ...
              <div className="bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-lg p-4 mb-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm opacity-90">Your personalized shopping experience</p>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{userStats.totalOrders}</div>
                      <div className="text-xs">Orders</div>
                    </div>
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{userStats.savedItems}</div>
                      <div className="text-xs">Saved</div>
                    </div>
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{userStats.rewardPoints}</div>
                      <div className="text-xs">Points</div>
                    </div>
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{userStats.memberSince}</div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="text-gray-600">
                    {filteredProducts.length} recommended items in <span className="font-medium text-green-600">Your Menu</span>
                  </span>
            ...
            <div className="mb-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
                <div className="flex items-center gap-2 text-green-700">
                  ...
                  <span className="text-sm">Track orders • Manage wishlist • Update profile • Contact support</span>
                </div>
              </div>
