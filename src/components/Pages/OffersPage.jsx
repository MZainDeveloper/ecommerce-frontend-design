...
const OffersPage = () => {
  ...
  // Filter products to show only those with discounts for Hot Offers
  const [filteredProducts, setFilteredProducts] = useState(products.filter(p => p.discount && p.discount > 0));
    ...
    <div className="bg-gray-50 min-h-screen">
      <div className="px-0 md:px-16 lg:px-24 py-2 md:py-6">
        ...
        <div className="text-sm text-gray-500 mb-4 md:mb-6 px-4 md:px-0">
          ...
          <span className="text-gray-900">Hot offers</span>
        </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="text-gray-600">
                    {filteredProducts.length} hot deals in <span className="font-medium text-red-600">Flash Sale</span>
                  </span>
            ...
            <div className="mb-4">
              <div className="bg-orange-50 border border-orange-200 rounded-lg p-3 mb-4">
                <div className="flex items-center gap-2 text-orange-700">
                  ...
                  <span className="font-medium">Hot Deals Alert:</span>
                  <span className="text-sm">All items below are on limited-time discount!</span>
                </div>
              </div>
