              ...
              <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg p-4 mb-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-sm opacity-90">Manage and track all your projects in one place</p>
                  </div>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{projectStats.activeProjects}</div>
                    ...
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">${(projectStats.totalBudget / 1000000).toFixed(1)}M</div>
                      <div className="text-xs">Budget</div>
                    </div>
                    <div className="bg-white/20 rounded-lg px-3 py-2 text-center">
                      <div className="text-lg font-bold">{projectStats.teamMembers}</div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="text-gray-600">
                    {filteredProducts.length} project items in <span className="font-medium text-blue-600">Portfolio</span>
                  </span>
            ...
            <div className="mb-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-4">
                <div className="flex items-center gap-2 text-blue-700">
                  ...
                  <span className="text-sm">Task management • Time tracking • Team collaboration • Budget monitoring</span>
                </div>
              </div>
