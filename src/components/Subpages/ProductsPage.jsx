...
const ProductsPage = () => {
  ...
  // Categories, brands, and features for filters
  const categories = [
    "Mobile accessory",
    "Electronics", 
    "Smartphones",
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <input
                          ...
                          style={{
                            background: `linear-gradient(to right, #3b82f6 0%, #3b82f6 ${(filters.priceRange[1]/2000)*100}%, #e5e7eb ${(filters.priceRange[1]/2000)*100}%, #e5e7eb 100%)`
                          }}
                        />
                      </div>
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div className="flex items-center gap-4">
                  <span className="text-gray-600">
                    {filteredProducts.length} items in <span className="font-medium">Mobile accessory</span>
                  </span>
